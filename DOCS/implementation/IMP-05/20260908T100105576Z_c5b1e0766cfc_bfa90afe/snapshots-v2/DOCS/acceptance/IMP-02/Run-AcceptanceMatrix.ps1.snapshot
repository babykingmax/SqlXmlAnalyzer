...
"@
    ...
    $summary=[ordered]@{
        schemaVersion=2; adapterVersion='2.4'; configuration=$Configuration; commandTimeoutSeconds=$CommandTimeoutSeconds; step='IMP-02'; runId=$runId; head=$head; runDirectory=$runDirectory
