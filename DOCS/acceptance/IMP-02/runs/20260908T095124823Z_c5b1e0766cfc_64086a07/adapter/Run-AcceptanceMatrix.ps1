...
"@
    ...
    $summary=[ordered]@{
        schemaVersion=2; adapterVersion='2.3'; configuration=$Configuration; commandTimeoutSeconds=$CommandTimeoutSeconds; step='IMP-02'; runId=$runId; head=$head; runDirectory=$runDirectory
    ...
    foreach ($dir in @('diagnostics','probe-diagnostics')) {
